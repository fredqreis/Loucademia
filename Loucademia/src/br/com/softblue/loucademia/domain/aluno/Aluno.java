...
public class Aluno implements Serializable {
	...
	public void gerarMatricula(String maxMatricula) {
		...
		if (maxMatricula == null) {
			maxMatricula = year + StringUtils.leftZerous(0, 4);
		}
		
		int sequencial = Integer.parseInt(maxMatricula.substring(4));
		sequencial++;
		
		this.matricula = year + StringUtils.leftZerous(sequencial, 4);
	}
	...
	public String toString() {
		return "Aluno [matricula=" + matricula + ", nome=" + nome + ", rg=" + rg + ", dataNascimento=" + dataNascimento
				+ ", email=" + email + ", sexo=" + sexo + ", situacao=" + situacao + ", endereco=" + endereco
				+ ", telefone=" + telefone + "]";
	}
